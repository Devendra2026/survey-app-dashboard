...
export function NoticeHeader({
  ...
  return (
    <header className="demand-notice-header dn-section relative z-1 rounded-md border border-slate-200 bg-white px-6 py-5 print:px-2 print:py-1.5">
      <div className="grid grid-cols-12 items-start gap-4">
        <div className="demand-notice-header-logo col-span-12 flex justify-center md:col-span-2 md:justify-start">
          <NoticeLogo ulbName={office.ulbName} logoUrl={logoUrl} />
        </div>

        <div className="demand-notice-header-title col-span-12 text-center md:col-span-10">
          ...
          <p className="demand-notice-hi mt-1 text-[12px] font-medium text-slate-700 print:mt-0.5 print:text-[6px]">
            संपत्ति कर मांग सूचना पत्र
          </p>
        </div>
      </div>
      <div className="mt-4 grid grid-cols-1 gap-2 border-t border-slate-200 pt-3 sm:grid-cols-3 print:mt-1 print:gap-1 print:pt-1">
