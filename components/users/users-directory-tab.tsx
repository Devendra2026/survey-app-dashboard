...
import { Building2, Layers, MapPin, Search, SlidersHorizontal, UserCheck, Users, X } from "lucide-react";
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <Select
                value={statusFilter}
                onValueChange={(value) => dispatchListUi({ type: "setStatusFilter", value })}
              >
